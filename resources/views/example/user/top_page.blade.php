                            ...
                            <div class="col-lg-12">
                                <div class="au-card m-b-30">
                                    <div class="au-card-inner">
                                        <h3 class="title-2 m-b-40">出勤</h3>
                                        <button type="button" class="btn btn-primary btn-lg btn-block">到着</button>
                                        <button type="button" class="btn btn-secondary btn-lg btn-block">帰宅</button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="au-card m-b-30">
                                    <div class="au-card-inner">
                                        <h3 class="title-2 m-b-40">一週間の出勤時間</h3>
